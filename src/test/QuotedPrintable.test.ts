...
import {QuotedPrintableEncoderStream, quoted_printable_encode_byte, quoted_printable_should_encode} from "../QuoatedPrintableEncoderStream";
...
describe('QuotedPrintable', function () {
  ...
  describe('QuotedPrintableEncoderStream', function() {
    it('Should encode the whitespace at the end of a line', async function() {
      ...
      let stream: QuotedPrintableEncoderStream= new QuotedPrintableEncoderStream();
